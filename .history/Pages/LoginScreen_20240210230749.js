...
const LoginScreen = ({ navigation }) => {
    ...
    const handleLogin = async () => {
        ...
        try {
            console.log(`tentative de connection au serveur de: ${email}`);
            // Envoyer les informations d'identification à votre serveur Node.js
            const response = await fetch('https://interapi-odap.onrender.com/login', {
                method: 'POST',
                headers: {
            ...
            console.log(`Réussi ! token : ${token}`);
